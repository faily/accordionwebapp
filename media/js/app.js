...
// $("#filelist ol > li").on("mouseenter", function() {
//   // $(this).addClass("hover");
//   $(this).find(".service-icon").addClass("hover");
// });

// $("#filelist ol > li").on("mouseleave", function() {
//   // $(this).removeClass("hover");
//   $(this).find(".service-icon").removeClass("hover");
// });
