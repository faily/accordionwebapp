...
DATABASES = {
    'default': {
        ...
        'NAME':  'accordion',                      # Or path to database file if using sqlite3.
        'USER': 'accordion_user',                      # Not used with sqlite3.
        'PASSWORD': 'KiX0Ka2u0UjwU4HL2HtDPtN2T3ZPTQ',                  # Not used with sqlite3.
...
SECRET_KEY = 'j?/7vIieqMew-$lieeul!`lZ$"7WWGVdKo<,Vn?$I4cTx)@v86'
